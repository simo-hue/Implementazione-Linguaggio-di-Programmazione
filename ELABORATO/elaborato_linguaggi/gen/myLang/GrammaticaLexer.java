...
public class GrammaticaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "T__13", "GE", "LE", "EQ", "NE", "GT", 
			"LT", "PLUS", "MINUS", "MUL", "DIV", "MOD", "POW", "AND", "OR", "NOT", 
			"ASSIGN", "SEMICOLON", "COLON", "LPAREN", "RPAREN", "LCURLY", "RCURLY", 
			"ID", "FLOAT", "INT", "DOT", "COMMA", "LBRAK", "RBRAK", "STRING", "WS", 
			"COMMENT"
		};
	}
